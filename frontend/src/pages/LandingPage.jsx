  ...
  return (
    <div className="relative z-10 mb-10 w-full group">
      ...
      <div className="relative bg-[#0B0E14] ring-1 ring-gray-900/5 rounded-3xl p-8 sm:p-12 overflow-hidden neon-hero-container">
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-cyan-500/5 rounded-full blur-[80px] transition-all duration-1000 ${animationState === "pulse" ? "opacity-30" : "opacity-0"}`}
        ></div>
        <div className="flex flex-col justify-center min-h-[180px] z-20 relative text-center sm:text-left">
          <h1
            className={`font-neon-sans text-5xl sm:text-7xl font-bold tracking-wider mb-4 transition-all duration-300 ${animationState === "initial" ? "opacity-0" : ""} ${animationState === "phase1" ? "animate-flicker-cyan" : ""} ${animationState === "phase2" || animationState === "pulse" ? "neon-cyan group-hover:animate-flicker-cyan-loop" : ""} ${animationState === "pulse" ? "animate-pulse-cyan" : ""} ${animationState === "glitch" ? "neon-cyan opacity-50 blur-[2px]" : ""} ${animationState === "dark" ? "text-gray-800 opacity-20" : ""}`}
          >
            I AM SKY
          </h1>
          <h2
            className={`font-neon-script text-3xl sm:text-5xl transition-all duration-300 ${animationState === "initial" || animationState === "phase1" ? "opacity-0" : ""} ${animationState === "phase2" || animationState === "pulse" ? "neon-pink" : ""} ${animationState === "pulse" ? "animate-pulse-pink" : ""} ${animationState === "glitch" ? "opacity-0 scale-95 duration-100" : ""} ${animationState === "dark" ? "opacity-0" : ""}`}
          >
            <span
              className={`${animationState === "phase2" ? "typed-caret-pink" : ""}`}
            >
              {typedSubtitle}
            </span>
          </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
            ...
            >
              <motion.div
                variants={fadeUp}
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-emerald-800 dark:text-primary text-xs font-bold mb-6 tracking-wide uppercase transition-colors duration-500"
              >
              ...
              <motion.p
                variants={fadeUp}
                className="text-lg text-emerald-700 dark:text-emerald-100/70 mb-10 leading-relaxed font-medium transition-colors duration-500"
              >
                Transforming ideas into digital reality with cutting-edge web
            ...
            >
              ...
              >
                <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-2xl shadow-emerald-900/10 dark:shadow-white/5 border border-emerald-900/5 dark:border-white/10 relative overflow-hidden max-w-md mx-auto flex items-center pr-2">
                  {/* Decorative Dashed Circle Top Left */}
                  <div className="absolute -top-12 -left-12 w-64 h-64 border-[3px] border-orange-400/30 border-dashed rounded-full pointer-events-none"></div>
                  ...
                  <div className="flex-1 flex flex-col items-start text-left relative z-20 py-8 pl-8 pr-2">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm font-medium leading-relaxed mb-6">
                      ...
                      Universiti Malaya, specializing in Data Science.
                    ...
                    <div className="flex items-center gap-3">
                      {[
                        ...
                        <a
                          key={i}
                          href={social.href}
                          className="w-8 h-8 rounded-full border border-gray-200 dark:border-gray-700 flex items-center justify-center text-orange-500 hover:bg-orange-50 dark:hover:bg-white/5 transition-colors"
                        >
                  ...
                  {/* Bottom Left Dashed decorative */}
                  <div className="absolute bottom-[-20px] left-[-20px] w-24 h-24 border-t-[3px] border-r-[3px] border-orange-400/30 border-dashed rounded-tr-[3rem] pointer-events-none opacity-50"></div>
                </div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <section className="py-20 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              variants={fadeUp}
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-emerald-800 dark:text-primary text-xs font-bold mb-4 tracking-wide uppercase transition-colors duration-500"
            >
            ...
            <motion.h2
              variants={fadeUp}
              className="text-3xl md:text-4xl font-extrabold text-emerald-900 dark:text-white tracking-tight transition-colors duration-500"
            >
              Why It Matters
            </motion.h2>
          </motion.div>
          ...
          >
            {[
              {
                value: "65%",
                label: "JB Non-Recycling Rate",
                icon: "delete",
                color: "text-red-500",
              },
              {
                value: "8M+",
                label: "Tonnes Waste / Year (MY)",
                icon: "warning",
                color: "text-amber-500",
              },
              {
                value: "70%",
                label: "Boost With Proper Sorting",
                icon: "trending_up",
                color: "text-primary",
              },
              {
                value: "∞",
                label: "Glass Is Infinitely Recyclable",
                icon: "recycling",
                color: "text-primary",
              },
            ].map((stat, i) => (
              ...
              >
                <span
                  className={`material-icons-round text-3xl mb-3 ${stat.color}`}
                >
                  {stat.icon}
                </span>
                <p className="text-4xl font-black text-emerald-900 dark:text-white tracking-tight transition-colors duration-500">
                  {stat.value}
                </p>
                <p className="text-sm font-bold text-emerald-700 dark:text-emerald-100/60 mt-2 transition-colors duration-500">
                  {stat.label}
                </p>
              </motion.div>
            ))}
            ...
            {[
              {
                icon: "local_shipping",
                title: "Smart Pickups",
                desc: "Schedule a collection in seconds. We handle everything efficiently.",
              },
              {
                icon: "center_focus_weak",
                title: "AI Classification",
                desc: "Aim your camera at trash and get instant bin recommendations.",
              },
              {
                icon: "redeem",
                title: "Eco-Rewards",
                desc: "Exchange recycling points for exclusive discounts at local partners.",
              },
            ].map((benefit, i) => (
              <motion.div
                key={i}
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-emerald-900 dark:text-white mb-4 tracking-tight transition-colors duration-500">
                  {benefit.title}
                </h3>
                <p className="text-emerald-700 dark:text-emerald-100/60 leading-relaxed font-medium transition-colors duration-500">
                  {benefit.desc}
                </p>
              </motion.div>
            ))}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="max-w-xl text-center md:text-left">
              <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight text-emerald-950">
                Ready to make an impact?
              </h2>
              <p className="font-bold text-emerald-900/80 text-xl">
                Join thousands of others making a real difference. Sign up today
                and get your first pickup free.
              </p>
            </div>

  ...
  <span className="inline-flex">
    {text.split("").map((char, i) => (
      <motion.span
        ...
        whileHover={{ y: -6, rotate: -4, transition: { type: "spring", stiffness: 400, damping: 12 } }}
      >
        {char === " " ? "\u00A0" : char}
      </motion.span>
    ))}
...
// ── Monochrome Glitch / Typewriter Component ──
const NeonSequence = () => {
  ...
  return (
    <div className="relative z-10 mb-10 w-full group">
      ...
      <motion.div
        className="relative bg-surface-light dark:bg-surface-dark ring-1 ring-black/5 dark:ring-white/10 rounded-3xl p-8 sm:p-12 overflow-hidden neon-hero-container"
...
const LandingPage = () => {
  ...
  return (
    <div className="font-display bg-background-light dark:bg-background-dark text-primary dark:text-primary-dark selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black overflow-hidden min-h-screen transition-colors duration-500">
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="max-w-2xl">
              ...
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
                <button onClick={() => scrollToSection("projects")} className="group relative bg-black dark:bg-white text-white dark:text-black px-8 py-4 rounded-full font-bold text-lg overflow-hidden transition-transform active:scale-95 cursor-pointer">
                ...
                <button onClick={() => scrollToSection("contact")} className="px-8 py-4 rounded-full font-bold text-lg border border-black/10 dark:border-white/20 hover:bg-black/5 dark:hover:bg-white/10 transition-colors cursor-pointer">
                  Contact Me
                </button>
              </motion.div>
            </motion.div>
      ...
      {/* Expertise Section — with Matrix Rain */}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {expertise.map((item) => (
              <motion.div
                ...
                className="p-8 rounded-3xl bg-white dark:bg-background-dark border border-black/5 dark:border-white/10 hover:border-black/20 dark:hover:border-white/20 transition-all duration-300 group backdrop-blur-sm"
              >
      ...
      {/* Footer / CTA — with Constellation */}
      <footer id="contact" className="py-20 border-t border-black/5 dark:border-white/10 text-center bg-surface-light dark:bg-surface-dark relative overflow-hidden">
        ...
        <div className="relative z-10">
          <motion.h2
            ...
            className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-10 select-none text-black dark:text-white"
          >
            GET IN TOUCH
          </motion.h2>
          <motion.button
            ...
            className="bg-black text-white dark:bg-white dark:text-black px-10 py-5 rounded-full font-bold text-xl transition-transform cursor-pointer shadow-xl shadow-black/20 dark:shadow-white/10"
          >
